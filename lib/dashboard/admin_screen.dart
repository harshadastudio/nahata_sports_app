// ─────────────────────────────────────────────────────────────────────────────
// LEGACY ADMIN DASHBOARD — COMMENTED OUT (superseded 2026-08-01)
//
// Everything below this banner is the previous admin dashboard: the old
// `AdminDashboardScreen`, `AdminDashboardScreen1` and their helpers. It is kept
// as comments rather than deleted, following this project's convention for
// superseded code.
//
// `AdminDashboardScreen` now resolves to the rebuilt console under
// `lib/features/admin/`. Re-exporting it from here means every existing call
// site — `auth/login.dart`, `auth/registration.dart`, `main.dart` — keeps
// working without a single import change.
// ─────────────────────────────────────────────────────────────────────────────

export 'package:nahata_app/features/admin/presentation/pages/admin_dashboard_page.dart'
...
// //                 // ID and Due
// //                 Text("ID: $id â€¢ Due: $due", style: const TextStyle(color: Colors.black54)),
// //                 // Amount
...
// // //             Text("ID: ${data["id"]} â€¢ Due: ${data["due"]}"),
// // //             Text(data["amount"] ?? ""),
...
// // //             if (isApproved) ...[
// // //               const SizedBox(height: 8),
// // //               const Text("âœ… Approved by Admin"),
...
// // //             if (isRejected) ...[
// // //               const SizedBox(height: 8),
// // //               const Text("âŒ Rejected by Admin", style: TextStyle(color: Colors.red)),
// // //             ],
// // //           ],
// // //         ),
// // //       ),
...
// // //                         id: int.tryParse(student['id'] ?? '0') ?? 0,
// // //                         due: fee['next_due_date'] ?? '',
// // //                         amount: "${fee['amount'] ?? '0'}", // Removed $ since you're using â‚¹
// // //                         coach: item['coachName'] ?? '',
// // //                         markedDate: fee['paid_date'] ?? '',
// // //                         approvedByAdmin: fee['admin_status'] == 'approved',
// // //                         gatePassIssued:
...
//       }
//     } catch (e) {
//       debugPrint("âŒ Notification fetch failed: $e");
//     } finally {
//       _isFetching = false;
//     }
//   }
